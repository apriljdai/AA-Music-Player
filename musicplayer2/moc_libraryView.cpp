...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LibraryView_t, stringdata) + ofs \
...
const QMetaObject LibraryView::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_LibraryView.data,
      qt_meta_data_LibraryView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LibraryView.stringdata))
